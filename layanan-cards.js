    ...
    reguler: [
      ...
      },
      {
        ...
        fasilitas: [
          ...
          ['hourglass', 'Program Umroh 16 Hari'],
          ['file',      'Izin PIHK Kemenag No. 91201141815930003'],
          ['stamp',     'Visa Umroh'],
          ['bus',       'Transportasi, City Tour & Handling Bandara/Hotel'],
          ['user',      'Muthawwif / Muthowwifah'],
          ['badge',     'Asuransi Perjalanan'],
          ['utensils',  'Free Makan Sahur'],
          ['sparkles',  'Free Tahalul, Tas Serut & Sajadah'],
        ],
        extra: {
          hotel: [['Makkah', 'Wahat Ajyad (Bintang 3)'], ['Madinah', 'ODST / Triple One (Bintang 3)']],
          hargaTitle: 'Harga Paket',
          harga: [
            ['Sharing (1 kamar 8 orang)', 'Rp 38.900.000'],
            ['Quad (1 kamar 4 orang)',    'Rp 46.700.000'],
            ['Triple (1 kamar 3 orang)',  'Rp 52.700.000'],
            ['Double (1 kamar 2 orang)',  'Rp 64.700.000'],
          ],
          benefitsTitle: "Keunggulan I'tikaf",
          benefits: [
            "Lokasi I'tikaf di Mezzanine (Area Perluasan Masjidil Haram)",
            'Kajian di Madinah & Makkah',
            "Kajian I'tikaf ba'da Ashar (Makkah) via Zoom",
            "Kajian ba'da Subuh (Madinah) di pelataran masjid",
            'Travel berizin resmi Kemenag',
          ],
          pembimbingTitle: 'Pembimbing Jamaah',
          pembimbing: ['Ustadz Novtriadi, Lc., M.Pd.'],
        },
      ...
      },
      {
        ...
        fasilitas: [
          ...
          ['plane',     'Tiket Pesawat Internasional'],
          ['bed',       'Hotel Madinah & Makkah'],
          ['utensils',  'Makan (Iftar & Sahur)'],
          ['bus',       'Bus Full AC'],
          ['stamp',     'Visa Umroh'],
        ],
        extra: {
          hotel: [['Makkah', 'Aziziyah Hotel (setaraf)'], ['Madinah', 'Triple One / Qasr Golden Tulip (setaraf)']],
          hargaTitle: 'Harga Paket',
          harga: [
            ['Quad (ber-4)',   'Rp 35.300.000'],
            ['Triple (ber-3)', 'Rp 37.000.000'],
            ['Double (ber-2)', 'Rp 40.500.000'],
          ],
          pembimbingTitle: 'Pembimbing Jamaah',
          pembimbing: ['Ustadz Shubron Jamil, Lc.'],
        },
        mitra: MITRA.elMarwa, harga: 'Rp35,3 juta', download: BROSUR.umrahItikafElMarwa,
      },
    ],
    khusus: [
      {
